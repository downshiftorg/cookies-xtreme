...
(function (global, undefined) {
    ...
    var emitter = function(target) {
      ...
      var mixin = {
        addListener: function(key, listener) {
          ...
          target.listeners[key].push(listener);
        },
        ...
        removeListener: function(key, listener) {
          ...
          var index = target.listeners[key].indexOf(listener);

          if (index === -1) {
            return;
          }

          target.listeners[key].splice(index, 1);
        },

        removeAllListeners: function(key) {
      ...
      var methods = Object.getOwnPropertyNames(mixin);
      methods.forEach(function (method) {
        target[method] = mixin[method].bind(target);
      });
      return target;
    };
    ...
    var factory = function (window) {
        ...
        // Cookies has event power
        Cookies = emitter(Cookies);
